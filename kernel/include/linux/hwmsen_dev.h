...
extern int hwmsen_gsensor_del(struct sensor_init_info* obj) ;         //Gionee yanggy 2012-03-30 add for ICS_KERNEL_EXIT func
#endif
...
extern int hwmsen_psensor_del(struct sensor_init_info* obj) ;
#endif
//Gionee mali 2012-05-29 modify for P-sensor MTK_compability policy begin
/*----------------------------------------------------------------------------*/
#endif 
