...
//*****************************************************************************************
//RX
//Gionee yanggy 2012-06-16 for version back begin    >>if any project need to modify this PARAMETER,move it to /gionee/project dir
#define FMR_RSSI_TH_LONG    0x0301
//Gionee yanggy 2012-06-16 for version back end
