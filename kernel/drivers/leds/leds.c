...
{	
 ...
 //gionee pengchao 20120428 added for the solomon ssd2825 clk start
...
//	pwm_setting.PWM_MODE_FIFO_REGS.LDURATION = 4;
	...
	printk("[LEDS]kernel: lcd_set_pwm :duty is %d\n");
 ...
 //gionee pengchao 20120428 added for the solomon ssd2825 clk end
#endif
