...
//gionee liuxw 2012-08-27 add for gionee sec func begin
#if defined (GN_RM_LK_SUPPORT)
#include <linux/delay.h>
#include <linux/gn_sec.h>
#endif
//gionee liuxw 2012-08-27 add for gionee sec func end
...
//gionee liuxw 2012-08-27 add for gionee sec func begin
#if defined (GN_RM_LK_SUPPORT) && !defined (BUILD_UBOOT)
		if (!go_rm_verified()){
		    mdelay(1200);
		}
#endif
